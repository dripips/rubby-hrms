class OffboardingTask < ApplicationRecord
  ...
  KINDS  = %w[kt_session access_revoke equipment_return exit_interview farewell paperwork general].freeze
  STATES = %w[pending in_progress done skipped].freeze

  belongs_to :offboarding_process, inverse_of: :tasks, touch: true
