class InterviewTomorrowNotifier < ApplicationNotifier
  ...
  notification_methods do
    def message
      r = round
      return "Завтра интервью" unless r

      I18n.t("notifications.interview_tomorrow",
             ...
             default: "Завтра: %{kind}-интервью с %{name} в %{time}",
